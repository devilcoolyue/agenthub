...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "dash.ov.events": "events today",
    "dash.ov.cost": "today",
    "dash.ov.risk": "risk",
    "dash.ov.risk.activity": "{n} activity",
    "dash.ov.risk.config": "{n} config",
    "dash.ov.status.active": "active",
    "dash.ov.status.idle": "idle",
    "dash.ov.status.configOnly": "config-only",
    "dash.ov.na": "—",
    // updater
    "update.available": "AgentHub {version} is available.",
    "update.install": "Update now",
    "update.downloading": "Downloading update…",
    "update.downloadingPct": "Downloading update… {pct}%",
    "update.relaunching": "Update installed — relaunching…",
    ...
    "set.defaultTerminal.hint": "Which terminal the “Resume” button uses for Claude or Codex sessions. ‘Auto’ picks the first detected terminal for this OS.",
  ...
  zh: {
    ...
    "dash.ov.cost": "今日花费",
    "dash.ov.risk": "风险",
    "dash.ov.risk.activity": "活动 {n}",
    "dash.ov.risk.config": "配置 {n}",
    "dash.ov.status.active": "活跃",
    "dash.ov.status.idle": "空闲",
    "dash.ov.status.configOnly": "仅配置",
    "dash.ov.na": "—",
    // 自动更新
    "update.available": "AgentHub {version} 已发布。",
    "update.install": "立即更新",
    "update.downloading": "正在下载更新…",
    "update.downloadingPct": "正在下载更新… {pct}%",
    "update.relaunching": "更新已安装 — 正在重启…",
    ...
    "set.defaultTerminal.hint": "“恢复会话”按钮（Claude / Codex）使用的终端。“自动”会选择当前系统上检测到的第一个终端。",
